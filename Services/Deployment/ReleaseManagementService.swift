...
private extension ReleaseManagementService {
    ...
    func checkAndProgressStaging(buildNumber: String, strategy: StagingStrategy) async {
        do {
    ...
    func calculateHealthScore(status: ReleaseStatus, crashes: [CrashReport], metrics: AppStoreMetrics) -> Double {
        var score = 100.0
    ...
    func submitForExpeditedReview(buildNumber: String, fixes: [CriticalFix]) async throws {
...
public class MonitoringService {
    ...
    public func collectMetrics(buildNumber: String) async throws -> [String: Any] {
        return [:]
    }
}
...
public enum ReleaseManagementError: Error, LocalizedError {
    ...
    public var errorDescription: String? {
        ...
        case .hotfixValidationFailed(let details):
        ...
        case .featureRolloutFailed(let details):
