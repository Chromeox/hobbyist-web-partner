-- HOBBY CREDIT SYSTEM UPDATE (Safe Version)
-- Updates credit system safely with existing object handling
...
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE 'Class tiers update: %', SQLERRM;
END $$;
...
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE 'Credit packs update: %', SQLERRM;
END $$;

-- ============================================
-- PART 3: CREDIT ROLLOVER TABLE (SAFE)
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_credit_rollovers_expiry ON credit_rollovers(expiry_date);
...
BEGIN
    ...
    RAISE NOTICE 'Rollover tracking: enabled';
END $$;