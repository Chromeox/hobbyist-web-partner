  ...
  public: {
    Tables: {
      ...
      classes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "classes_tier_id_fkey"
            columns: ["tier_id"]
            isOneToOne: false
            referencedRelation: "class_tiers"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      credit_insurance_plans: {
        Row: {
          ...
          id: string
          is_active: boolean | null
          max_protected_credits: number | null
      ...
      retention_metrics: {
        Row: {
          average_classes_per_week: number | null
          churn_risk: string | null
          created_at: string | null
          favorite_category: string | null
          favorite_studio_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "retention_metrics_favorite_studio_id_fkey"
            columns: ["favorite_studio_id"]
            isOneToOne: false
            referencedRelation: "studios"
            referencedColumns: ["id"]
          },
      ...
      revenue_shares: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "revenue_shares_instructor_id_fkey"
            columns: ["instructor_id"]
            isOneToOne: false
            referencedRelation: "instructors"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "revenue_shares_studio_id_fkey"
            columns: ["studio_id"]
            isOneToOne: false
            referencedRelation: "studios"
            referencedColumns: ["id"]
      ...
      squads: {
        ...
        Relationships: [
          {
            foreignKeyName: "squads_creator_id_fkey"
            columns: ["creator_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      studio_onboarding_submissions: {
        ...
        Relationships: [
          {
            foreignKeyName: "studio_onboarding_submissions_studio_id_fkey"
            columns: ["studio_id"]
            isOneToOne: false
            referencedRelation: "studios"
            referencedColumns: ["id"]
      ...
      user_insurance_subscriptions: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_insurance_subscriptions_insurance_plan_id_fkey"
            columns: ["insurance_plan_id"]
            isOneToOne: false
            referencedRelation: "credit_insurance_plans"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "user_insurance_subscriptions_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      process_credit_refund: {
        Args:
          | { booking_id: string; refund_reason?: string }
          | {
              p_amount: number
              p_description: string
      ...
      update_calendar_sync_status: {
        Args:
          | { error_msg?: string; integration_id: string; status: string }
          | { sync_status: string; user_id: string }
        Returns: undefined
      }
    }
    Enums: {
