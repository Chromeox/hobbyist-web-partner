...
export default function LocationManagement() {
  ...
  const renderLocationCard = (location: StudioLocation) => (
    <motion.div
      key={location.id}
      className="glass-morphism p-6 rounded-xl cursor-pointer hover:scale-[1.02] transition-transform"
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div>
          ...
          <p className="text-xl font-semibold text-white">{location.stats.activeClasses}</p>
        </div>
        <div>
          <p className="text-xs text-gray-400">Students</p>
          <p className="text-xl font-semibold text-white">{location.stats.totalStudents}</p>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <p className="text-xl font-semibold text-white">{location.stats.fillRate}%</p>
      ...
      <div className="flex items-center justify-between pt-4 border-t border-gray-700">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-sm text-white">{location.manager.name}</p>
            <p className="text-xs text-gray-400">Manager</p>
          </div>
        </div>
        <div className="flex items-center gap-1">
          <Star className="w-4 h-4 text-yellow-400 fill-current" />
          <span className="text-sm text-white font-medium">{location.stats.avgRating}</span>
        </div>
      </div>
    </motion.div>
  );
  ...
  const renderLocationDetails = () => {
    ...
    return (
      ...
      >
        <motion.div
          className="glass-morphism rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden"
          ...
          <div className="p-6 border-b border-gray-700">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-gray-400 mt-1">{selectedLocation.address}, {selectedLocation.city}</p>
              </div>
              <button
                onClick={() => setSelectedLocation(null)}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {Object.entries(selectedLocation.operatingHours).map(([day, hours]) => (
                      <div key={day} className="flex justify-between items-center p-3 bg-gray-800 rounded-lg">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="text-center">
                      ...
                      <div className="text-sm text-gray-400">Active Classes</div>
                    </div>
                    <div className="text-center">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-gray-800 rounded-lg">
                      <div>
                        <p className="text-white font-medium">Primary Location</p>
                        <p className="text-sm text-gray-400">This location appears first in searches</p>
                      </div>
                      <button
                    ...
                    <div className="flex items-center justify-between p-4 bg-gray-800 rounded-lg">
                      <div>
                        <p className="text-white font-medium">Accept Online Bookings</p>
                        <p className="text-sm text-gray-400">Students can book classes at this location</p>
                      </div>
                      <button
                        className={`relative inline-flex h-6 w-11 items-center rounded-full ${
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-400">Manage your studio locations across the city</p>
          </div>
          <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
        <div className="glass-morphism p-4 rounded-xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-white">{totalStats.locations}</p>
        ...
        <div className="glass-morphism p-4 rounded-xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-white">{totalStats.activeClasses}</p>
        ...
        <div className="glass-morphism p-4 rounded-xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-white">{totalStats.totalStudents}</p>
        ...
        <div className="glass-morphism p-4 rounded-xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-white">{totalStats.avgFillRate}%</p>
