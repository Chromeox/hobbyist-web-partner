-- ============================================
-- FIXED SECURITY MIGRATION FOR HOBBYIST
-- Handles existing tables and column conflicts
-- ============================================
...
-- ============================================
-- PART 3: DROP AND RECREATE SECURITY TABLES
-- ============================================

-- Drop existing security tables if they exist (to avoid column conflicts)
DROP TABLE IF EXISTS security_audit_log CASCADE;
DROP TABLE IF EXISTS failed_login_attempts CASCADE;
DROP TABLE IF EXISTS api_rate_limits CASCADE;

-- Recreate security audit log table with correct schema
...
-- ============================================
-- PART 5: CREATE SECURITY INDEXES
-- ============================================
...
BEGIN
    ...
    PERFORM log_security_event(
        ...
        'success',
        jsonb_build_object(
            'migration', 'fixed_security_enhancements',
            'timestamp', NOW()
        )
    );
